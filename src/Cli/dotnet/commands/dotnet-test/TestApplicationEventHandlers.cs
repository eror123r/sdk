...
namespace Microsoft.DotNet.Cli
{
    internal sealed class TestApplicationsEventHandlers
    {
        ...
        public void OnHandshakeReceived(object sender, HandshakeArgs args)
        {
            ...
            (string ModulePath, string TargetFramework, string Architecture, string ExecutionId) appInfo = new(testApplication.Module.RunInformation.RunCommand, tfm, arch, executionId);
